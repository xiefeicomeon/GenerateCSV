...
def generateCSV(Originsheet_path,  Output_path):
    ...
    # 读取站端遥信表
    Origin_sheet_yx = pd.read_excel(Originsheet_path, "遥信",dtype=object)
    ...
    # 读取主站遥测表
    Origin_sheet_yc = pd.read_excel(Originsheet_path, "遥测",dtype=object)
    ...
    # 读取主站遥控表
    Origin_sheet_yk = pd.read_excel(Originsheet_path, "遥控", dtype=object)
    # print(Origin_sheet_yk)
    # 保存主站遥控
    ...
    Origin_sheet_yt.to_csv(YT_path, encoding="gbk", index=None,float_format=str)
